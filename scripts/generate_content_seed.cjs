...
function main() {
  ...
  sql.push("BEGIN;");
  sql.push("TRUNCATE TABLE lesson_progress, lesson_nec_references, lesson_topic_tags, module_topic_tags, lesson_sections, lessons, modules, nec_entry_topic_tags, nec_search_index, nec_entries, topic_tags RESTART IDENTITY CASCADE;");
